        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card lesson-card">
                    <img src="https://placehold.co/400x200" class="card-img-top" alt="สนทนา">
                    <div class="card-body">
                        <h5 class="card-title">บทที่ 3: การสนทนาในชีวิตประจำวัน</h5>
                        <p class="card-text">เรียนรู้บทสนทนาพื้นฐานที่ใช้ในชีวิตประจำวัน</p>
                        <div class="lesson-stats mb-3">
                            <span><i class="fas fa-clock"></i> 60 นาที</span>
                            <span><i class="fas fa-book-reader"></i> 5 หัวข้อ</span>
                        </div>
